...
hold on
plot(B,OPTB(:,shok),'LineWidth',3.5,'color',de)
hold on
plot(B,OPTBp(:,shok),'LineWidth',2.5,'LineStyle','-.','color',sp)
hold on
...
plot(B(aa+1:end),taxp(aa+1:end,shok),'-','LineWidth',2.5,'color', colorpol); hold on
...
WELFDIF= ((valuefp./valuef)).^(1/(1-SIG))-1;
