...
#                                  FIG 1 and 2                                 #
# ---------------------------------------------------------------------------- #
fig1_1=plot(w0_grid,K0, legend=:none,title=L"", framestyle = :box,xaxis=(L"w_0"));
       plot!(w0_grid,B1',legend=:none,title=L"k_0 \ and \ b_1",linestyle=:dash, framestyle = :box);

fig1_2=plot(w0_grid,H1',legend=:none,title=L"h_1", framestyle = :box,xaxis=(L"w_0"));

fig1_3=plot(w0_grid,K1',legend=:none,title=L"k_1", framestyle = :box,xaxis=(L"w_0"));
       plot!(w0_grid,B2',legend=:none,title=L"b_2",linestyle=:dash, framestyle = :box);

fig1 = plot(fig1_1,fig1_2,fig1_3, layout=(1,3), dpi=1200 , size=(700,400))


fig2 = plot(pl_l1,pl_l2, layout=(1,2), dpi=1200 , size=(700,400))


pl_dividend2=plot(w0_grid,D2',palette=col,legend=:none,
                title=L"Dividend $d_2(s)$",xaxis=(L"w_0"),
                 framestyle = :box);
pl_cash1=plot(w0_grid,cash1',palette=col,legend=:none,
                title=L"Cash flow$_{t=1}$",xaxis=(L"w_0"),
                framestyle = :box)

fig3=plot(pl_cash1,pl_dividend2,pl_hr, layout=(1,3),
                                        dpi=1200 ,
                                        size=(700,400))
...
cd(dirname(@__FILE__))
savefig(p1,"./Figures/dist_rampini.pdf")
